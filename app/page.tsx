...
const buttonPrimary = `${buttonBase} bg-lime-400 text-black hover:scale-105 hover:shadow-2xl hover:shadow-lime-500/70 hover:brightness-110`;
const buttonSecondary = `${buttonBase} border-2 border-white text-white bg-transparent hover:bg-white hover:text-black`;
        ...
        <>
            ...
            {!loading && (
                <div className="relative min-h-screen overflow-hidden font-sans">
                    ...
                    <header className="absolute top-0 left-0 right-0 flex items-center justify-between p-8 z-30">
                        {/* Logo - Top Left */}
                    ...
                    <main className="relative z-20 flex min-h-screen items-center justify-center w-full max-w-7xl mx-auto px-8">
                            ...
                            <div className="grid grid-cols-5 gap-16 items-start">
                                ...
                                <div className="col-span-3 flex flex-col">
                                    <div className="[text-shadow:2px_2px_8px_rgba(0,0,0,0.6)]">
                                        <h1 className="text-8xl font-extrabold text-white leading-none tracking-tighter">WHERE THE FLAG</h1>
                                        <h2 className="mt-4 text-5xl font-bold text-red-500">Hack The Box Chennai</h2>
                                    </div>
                                    <p className="mt-8 text-gray-300 text-xl max-w-xl">One Heist. One Flag. Total Control.</p>
